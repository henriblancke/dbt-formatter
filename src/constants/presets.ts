...
export const presets: SqlPresets = {
  reservedWords: {
    ...
    default: ['A', 'ABS', 'ACCESSIBLE', 'ACOS', 'ACOSH', 'ADD_MONTHS', 'AGENT',
      ...
      'TO_NUMERIC', 'TO_OBJECT', 'TO_TIME', 'TO_TIMESTAMP', 'TO_VARIANT',
      'TO_XML', 'TRAILING', 'TRANSACTION', 'TRANSACTIONAL', 'TRANSLATE',
      'TRATION_HISTORY', 'TRIGGER', 'TRIM', 'TRUE', 'TRUNC', 'TRUNCATE',
